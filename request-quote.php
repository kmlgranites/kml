...
<body>
  <div class="wrapper">
      ...
      <nav class="navbar navbar-expand-lg sticky-navbar">
        <div class="container">
          <a class="navbar-brand" href="index.html">
            <img src="assets/images/logo/logo-light.png" class="logo-light" alt="logo" width="100">
            <img src="assets/images/logo/logo-dark.png" class="logo-dark" alt="logo" width="100">
          </a>
              ...
              <li class="d-none d-lg-block">
                <div class="module__btn module__btn-phone d-flex align-items-center">
                  ...
                  <div>
                    ...
                    <a href="tel:7299911652">+91 7299911652</a>
                  </div>
                </div>
              </li>
            </ul><!-- /.modules-wrapper -->
    ...
    <!-- ========================
       page title 
    =========================== -->
    <section id="pageTitle" class="page-title page-title-layout10 bg-overlay bg-parallax">
      <div class="bg-img"><img src="assets/images/page-titles/2.jpg" alt="background"></div>
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6">
            <h1 class="pagetitle__heading">Connect with us!</h1>
            <p class="pagetitle__desc">We would love to hear from you! Please feel free to contact us for any further information 
            or business queries on our products and services.</p>
          </div><!-- /.col-xl-8 -->
        </div><!-- /.row -->
      </div><!-- /.container -->
    </section><!-- /.page-title -->
              ...
              <div class="request__panel-banner bg-overlay bg-overlay-theme">
                ...
                <div class="request__panel-banner-inner">
                  ...
                  <button class="btn btn__secondary btn__hover2">
                    <i class="icon-printer"></i><span>Download 2023 Brochure</span>
                  </button>
                </div><!-- /.request-panel-banner-inner -->
              </div><!-- /.request-panel-banner -->
              <?php
    if (!empty($thank_you_message)) {
        echo '<p style="color: green;">' . $thank_you_message . '</p>';
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6">
                      <div class="form-group">
                        <input type="text" id="name" name="name" required type="text" class="form-control" placeholder="Name">
                      </div>
                    </div><!-- /.col-lg-6 -->
                    <div class="col-sm-6 col-md-6 col-lg-6">
                      <div class="form-group">
                        <input id="email" name="email" required type="email" class="form-control" placeholder="Email">
                      </div>
                    </div><!-- /.col-lg-6 -->
                    <div class="col-sm-6 col-md-6 col-lg-6">
                      <div class="form-group">
                        <input  type="text" id="phone" name="phone" required type="text" class="form-control" placeholder="Phone">
                      </div>
                    </div><!-- /.col-lg-6 -->
                    <div class="col-sm-6 col-md-6 col-lg-6">
                      <div class="form-group form-group-select">
                       <select class="form-control" id="granite_type" name="granite_type" required>
                        <option>Granite Type</option>
                        <option>Slabs</option>
                        <option>Monuments</option>
                        <option>Vases</option>
                        <option>Plaques</option>
                        <option>Kerb Sets</option>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                      <div class="form-group">
                        <textarea id="message" name="message" class="form-control" placeholder="Additional Details!" required></textarea>
                      </div>
                    </div><!-- /.col-lg-6 -->
                    <div class="col-sm-12 col-md-12 col-lg-12">
                      <button type="submit" value="Submit" class="btn btn__secondary">Submit Request</button>
                    </div><!-- /.col-lg-12 -->
                  </div>
                </div>
        ...
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-12 text-center mt-40">
            <p class="text__link mb-0">We will get back to you within 24 hours, or call us
              <span class="font-bold color-theme">+91 7299911652</span></p>
          </div><!-- /.col-lg-12 -->
        </div><!-- /.row -->
      </div><!-- /.container -->
          ...
          <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-3 footer__widget footer__widget-about  mb-30">
              <div class="footer__widget-content">
                <img src="assets/images/logo/logo-footer.png" alt="logo" width="100">
                <p>No.6/858, Natham Sipcot Road, <br>Thazhambur, Tamilnadu 600 130.</p>
              </div>
            </div><!-- /.col-lg-4 -->

            <div class="col-6 col-sm-6 col-md-3 col-lg-3 footer__widget footer__widget-nav">
              <h6 class="footer__widget-title">Mail us</h6>
                             <p><a href="mailto:ontact@kmlgranites.com">contact@kmlgranites.com</a></p>
<!-- /.footer-widget-content -->
            </div><!-- /.col-lg-2 -->

            <div class="col-6 col-sm-6 col-md-3 col-lg-4 footer__widget footer__widget-nav">
              <h6 class="footer__widget-title">Call Us</h6>
       <p><a href="tel:+91 9381040448" class="font-weight-bold color-white">+91 938 104 0448</a> / <a href="tel:+91 9789000363" class="font-weight-bold color-white">+91 978 900 0363</a></p>
                  ...
                  <ul class="list-unstyled footer__copyright-links d-flex flex-wrap">
                    <li>
                      <a href="http://themeforest.net/user/7oroof">
                        &copy; 2023 kmlgranites, with Love by <span class="color-theme">vkpixels.art</span>
                      </a>
                    </li>
